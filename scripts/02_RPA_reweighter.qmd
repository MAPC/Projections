...
for (yr in c(2030, 2035, 2040, 2045, 2050)) {
  x <- readRDS(
    paste0(
      "K:/DataServices/Projects/Current_Projects/Projections/Projections_2028/Data/01_Regional_Control_Totals/SHoP_Scenarios/Reweighter_Outputs/Scenario_3/bad_MAPC101/processor_corrected_PUMS_Scenario_3_",
      yr,
      ".rds"
    ))
    hh <- x[SPORDER == 1, round(sum(new_WGTP)), mpo]
