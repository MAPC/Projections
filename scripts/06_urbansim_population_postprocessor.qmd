...
# 3.5.1 - Post-processor 05 - CTPS microsim household export
...
# 3.5.2 - Table & Shapefile Export for Website

```{r}
# Export for Projections Website
dir <- 'Microsim_outputs'
...
fwrite(
  ...
  paste0(
    r2,
    'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular/muni_HHpop_',
    yr + 1,
    '.csv'
  )
)
...
fwrite(
  ...
  paste0(
    r2,
    'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular/muni_HHpop_age_',
    yr + 1,
    '.csv'
  )
)
...
fwrite(
  ...
  paste0(
    r2,
    'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular/muni_HHpop_u18_',
    yr + 1,
    '.csv'
  )
)
...
fwrite(
  ...
  paste0(
    r2,
    'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular/muni_HHType_',
    yr + 1,
    '.csv'
  )
)
...
fwrite(
  ...
  paste0(
    r2,
    'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular/muni_HHDer_age_',
    yr + 1,
    '.csv'
  )
)
...
fwrite(
  ...
  paste0(
    r2,
    'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular/muni_HH_income_',
    yr + 1,
    '.csv'
  )
)

semp <- fread(paste0(root, SWM_run, '/', yr, '/jobs.csv'))
memp <- fread(paste0(root, MAPCM_run, '/', yr, '/jobs.csv'))
...
fwrite(
  ...
  paste0(
    r2,
    'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular/muni_employment_',
    yr + 1,
    '.csv'
  )
)
...
f1 <- list.files(path = paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular'), pattern = 'muni_HHpop_2', full.names = T)

f2 <- list.files(path = paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular'), pattern = 'muni_HHpop_age', full.names = T)
                 
f3 <- list.files(path = paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular'), pattern = 'muni_HHpop_u18', full.names = T)

f4 <- list.files(path = paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular'), pattern = 'muni_HHType', full.names = T) 

f5 <- list.files(path = paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular'), pattern = 'muni_HHDer', full.names = T)                 

f6 <- list.files(path = paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular'), pattern = 'muni_HH_income', full.names = T)

f7 <- list.files(path = paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular'), pattern = 'muni_employment', full.names = T)
...
dw7 <- pivot_wider(d7, id_cols = c('rpa_acr','mpo','muni_name','SuperSector_ID','SuperSector'), names_prefix = 'Employment_',names_from = 'year', values_from = 'jobs')

emptot <- d7 |> 
  group_by(rpa_acr,mpo,muni_name,year) |> 
  summarize(jobs=sum(jobs)) |> 
  mutate(SuperSector_ID=100,
         SuperSector='Total Employment') |> 
  pivot_wider(id_cols = c('rpa_acr','mpo','muni_name','SuperSector_ID','SuperSector'), names_prefix = 'Employment_',names_from = 'year', values_from = 'jobs') |> rbind(dw7) |> 
  setorder(muni_name,SuperSector_ID)

xl.list <- list('Household Population' = d1, 'Household Population by Age' = d2, 'Household Population Under 18' = d3, 'Households by Type' = d4, 'Households by Age of HHder' = d5, 'Households by HH Income Group' = d6, 'Employment by Super Sector' = emptot)

write_xlsx(xl.list, paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Tabular/LRTP2023_Municipal_Data_revised_20250929.xlsx'))
...
sf.hhpop <- sfm |> 
  ...
  st_write(paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Spatial/Projections_2023_revised_webmap/muni_HHpop.shp'), append=F)

hhtot <- d4 |> filter(`Household Type`=='Total Households') |> select(-`Household Type`) |> rename(HH2020=Households_2020,HH2030=Households_2030,HH2040=Households_2040,HH2050=Households_2050)
sf.hhds <- sfm |> 
  left_join(hhtot, by = c('muni_id'='Muni_ID')) |> 
  st_write(paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Spatial/Projections_2023_revised_webmap/muni_HHds.shp'), append=F)

et <- emptot |> filter(SuperSector_ID==100) |> select(-SuperSector_ID,-SuperSector) |> 
  rename(RPA=rpa_acr,MPO=mpo,Muni=muni_name,jobs2020=Employment_2020, jobs2030=Employment_2030, jobs2040=Employment_2040,jobs2050=Employment_2050)
sf.hhds <- sfm |> 
  left_join(et, by = c('muni_name'='Muni')) |> 
  st_write(paste0(r2,'Data/04_Allocation_Results/Revised_Allocation_Sept2025/Spatial/Projections_2023_revised_webmap/muni_employment.shp'), append=F)
