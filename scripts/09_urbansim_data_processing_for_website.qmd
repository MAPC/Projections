...
```
# 5.1 - Level Demographic Components of Projected Households (Stacked Bar Charts)
```{r}
# Overall
# Household Type
...
# 5.2 Level Components of Projected Employment (Stacked Bar Charts)
```{r}
# Overall
# Supersectors
...
# 5.3 Level Projected Population (Stacked Bar Charts)
```{r}
# State
# Overall
pop.bc.1 <- pop |> 
...
# 5.4 Percent Change Demographic Components of Projected Households (Stacked Bar Charts)
```{r}
# Overall
# Household Type
...
# 5.5 Percent Change Components of Projected Employment (Stacked Bar Charts)
```{r}
# Overall
# Supersectors
...
# 5.6 Percent Change Projected Population (Stacked Bar Charts)
```{r}
# Overall
# Age 
