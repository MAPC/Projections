...
pop.bc.1 <- pop |> 
  ...
  geom_col(state = "identity", width = .5, fill = "lavender", color = "black") +
  geom_text(aes(label = scales::comma(hh.population)), vjust = -1) +
  labs(
    title = "Projected Household Population, Massachusetts (2020-2050)",
    x = "Year",
    y = "Population"
  ) +
